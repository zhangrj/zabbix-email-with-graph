...
class Zabbix_Graph(object):
    ...
    def get_graph(self, itemid=None):
        ...
        if len(re.findall('4.2', self.zapi.api_version())) == 1:
...
if __name__ == "__main__":
    ...
    if img == "ERROR":
        ...
        os.system("/usr/local/bin/sendEmail -f " + smtp_user + " -t " + receiver + " -s " + smtp_server + " -u \'" + subject + "\' -o message-content-type=html -o message-charset=utf-8 -xu " + smtp_user + " -xp " + smtp_pwd + " -o message-file=/usr/lib/zabbix/alertscripts/email.html")
    else:
